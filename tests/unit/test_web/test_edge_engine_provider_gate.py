...
def _minimal_snapshot() -> VolSnapshot:
    return VolSnapshot(
        ...
        historical_move_uncertainty_pct=0.80, historical_vs_implied_move_ratio=1.1793,
        tail_vs_implied_move_ratio=0.7478, smile_curvature=-0.62, smile_concavity_flag=True, smile_points=7,
