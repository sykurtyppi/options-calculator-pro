...
_MIGRATION_COLUMNS: Dict[str, str] = {
    ...
    "exit_quote_timestamp": "TEXT",
    "exit_bid_ask_mid_json": "TEXT",
    # Codex F1: historical_vs_implied_move_ratio changed scale (fair went from
    # ≈0.755 to 1.0). NULL = legacy-scale row written before the change; 2 =
    # corrected units. Never rewrite history — version it.
    "move_ratio_units_version": "INTEGER",
    "exit_execution_scenarios_json": "TEXT",
    "surface_quality_status": "TEXT",
    "surface_quality_reasons_json": "TEXT",
    "surface_quality_json": "TEXT",
...
class OutcomeStore:
    ...
    def insert_entry(
        ...
        *,
        ...
        move_ratio_units_version: Optional[int] = None,
        ...
        sql = """
            INSERT OR IGNORE INTO outcome_trades (
                ...
                historical_vs_implied_move_ratio, move_ratio_units_version, term_structure_slope,
