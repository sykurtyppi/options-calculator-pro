...
# ── Sample provenance taxonomy (PR-AD commit 1b, Codex review) ────────────
#
...
#   Requires explicit pre-registration documenting which (symbol, date)
#   universe was set aside and when. No such holdout exists today; this
...
#   explicitly tag provenance — fail-closed.
