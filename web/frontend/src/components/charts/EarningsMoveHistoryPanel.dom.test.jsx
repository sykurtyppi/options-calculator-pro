...
describe('EarningsMoveHistoryPanel', () => {
  test('renders the chart and a caption with median / implied / exceed count', () => {
    const { container } = render(
      <EarningsMoveHistoryPanel history={HISTORY} impliedMove={6} medianPct={8} sampleSize={4} />,
    )
  ...
  test('takeaway flips with the exceed rate', () => {
    ...
    rerender(
      <EarningsMoveHistoryPanel history={HISTORY} impliedMove={20} medianPct={8} sampleSize={4} />,
    )
  ...
  test('renders nothing when there is no dated history (fallback path)', () => {
    const { container } = render(
      <EarningsMoveHistoryPanel history={null} impliedMove={6} medianPct={8} sampleSize={0} />,
    )
